...
from con_encoder.x_transformer import Encoder, TransformerWrapper  # TODO: can we directly rely on lucidrains code and simply add this as a reuirement? --> test
...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    openai/clip-vit-large-patch14           原始的version
    """
    def __init__(self, version="../con_encoder/clip-vit-large-patch14",
